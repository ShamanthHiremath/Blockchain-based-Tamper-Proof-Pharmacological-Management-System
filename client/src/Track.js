    ...
    return (
        <div className="track-container">
            <div className="track-header">
                ...
                <span onClick={redirect_to_home} className="track-home-button"> HOME</span>
            </div>
            <table className="track-table table table-sm table-bordered">
                <thead>
                    <tr>
            ...
            <h5 style={{marginTop: '28px'}}>Enter Medicine ID to Track it</h5>
